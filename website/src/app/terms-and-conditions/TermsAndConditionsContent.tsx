...
const sections: TermsSection[] = [
  ...
  { title: "10. Profile Creation", paragraphs: ["Users may upload or submit content such as profile details, portfolio images, reviews, messages, and service information.", "You retain ownership of your content, but grant FEAG permission to use, display, reproduce, and distribute it as needed to operate, promote, and improve the Platform."] },
    ...
    <main className="relative isolate flex-1 overflow-hidden bg-[#FFF9F2] px-3 py-10 min-[360px]:px-4 sm:px-6 sm:py-16 lg:px-8">
      ...
      <section className="mx-auto max-w-4xl">
        <header className="rounded-[2rem] border border-white/70 bg-white/55 px-6 py-10 text-center shadow-[0_20px_60px_rgba(152,82,0,0.12)] backdrop-blur-xl sm:px-12 sm:py-14">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-relaxed text-[#6D5F52] sm:text-base">Accessing and Using the FEAG Platform, website or mobile application are a set of rules and guidelines for users which must be agree to abide by in order to use a service or product.</p>
