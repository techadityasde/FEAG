...
export default function Step1Mobile({
  ...
  const handleGoogleSignIn = () => {
    ...
    setTimeout(() => {
      ...
      toast.success("Successfully authenticated with Google!", { id: "google-oauth" });
  ...
  return (
    <div className="flex flex-col gap-5 animate-in fade-in duration-300">
      <div>
        <h2 className="text-lg font-bold text-[#2E2215]">Mobile Number Verification</h2>
        <p className="text-xs text-muted-foreground mt-0.5">Please verify your contact number to begin onboarding.</p>
      </div>
